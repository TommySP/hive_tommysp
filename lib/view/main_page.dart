...
import 'package:hivetommysp/model/monster.dart';

class MainPage extends StatelessWidget {
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("TommySoemitro-Hive DB"),
            ...
            if (snapshot.connectionState == ConnectionState.done) {
              if (snapshot.hasError)
                ...
                if (monstersBox.length == 0) {
                  monstersBox.add(Monster("Manusia", 1));
                  monstersBox.add(Monster("Hewan", 5));
                }
